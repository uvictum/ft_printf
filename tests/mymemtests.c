...
int	main()
{
	...
	ft_memcpy(testmemcpy + 7, testmemcpy + 4, 4);
	...
	ft_memccpy(testmemccpy + 7, testmemccpy + 4, 'n', 3);
	...
	ft_memmove(testmemmove + 7, testmemmove + 4, 4);
	...
	rslt = ft_memcmp(testmemcmp1, testmemcmp2, 8);
	printf("%i",rslt);
